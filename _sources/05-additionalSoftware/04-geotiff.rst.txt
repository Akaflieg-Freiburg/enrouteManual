...
able to import and use third-party visual approach charts in GeoTIFF format.
Since GeoTIFF is an exceptionally complex format that covers use cases ranging
from astronomy to high-precision land survey, **Enroute Flight Navigation** only
