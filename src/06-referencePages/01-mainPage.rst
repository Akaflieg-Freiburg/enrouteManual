...
.. _movingMapFlt:
.. figure:: ../03-tutorialBasic/autogenerated/02-02-04-EnRoute.png
   :scale: 30 %
   :align: center
...
- Depending on the settings made in the :ref:`settings_page`, the field T.ALT
...
section :ref:`senseandavoid` explains how to establish the connection. The
figure :ref:`EDTFtraffic2` shows a typical situation.

.. _EDTFtraffic2:
.. figure:: ../03-tutorialBasic/autogenerated/02-01-01-traffic.png
   :scale: 30 %
   :align: center
...
.. image:: traffic-paraglider.png    Paraglider
.. image:: traffic-withDirection.png Unknown traffic type.
.. image:: traffic-noDirection.png   The traffic is not moving, or direction of movement is unknown.
==================================== ========
...
from the Navigation Bar at the bottom of the page.  To close the side view, tap
the close button in its top right corner, or drag the side view down towards
the Navigation Bar.
...
How can I provide static pressure data?
  ...
  Follow the steps outlined in chapter :ref:`senseandavoid` to connect **Enroute
