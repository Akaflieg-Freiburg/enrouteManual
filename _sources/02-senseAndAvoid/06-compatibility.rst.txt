...
- `PowerFLARM Core <https://flarm.com/flarm-product/powerflarm-core-pure/>`_ by
  ...
  <https://www.air-avionics.com/?page_id=401>`_ Wi-Fi Adapter by `Air Avionics
...
- Classic FLARM and the `ICFly Connect <https://in-circuit.de/shop/icfly-connect>`_
  Wi-Fi adapter, set to IP 192.168.1.1 and TCP Port 2000.
...
- Classic FLARM and `SH-B23A(SH-B30) Bluetooth 2.0 to RS232 Serial Adapter
...
- Classic FLARM and HC-06 Bluetooth Adapter.
